...
public class PayService {
	...
	public KakaoPayReadyVo kakaoPay(Map<String, Object> params, String uuid, String username, String[] tbodyArray) {
		...
		payParams.add("approval_url", "http://reacthms.kro.kr:8081/pay/success"); // 성공하면 예약성공페이지로
		payParams.add("cancel_url", "http://reacthms.kro.kr:8081/pay/cancel"); // 취소시 예약페이지
		payParams.add("fail_url", "http://reacthms.kro.kr:8081/pay/fail"); // 실패시 예약페이지
